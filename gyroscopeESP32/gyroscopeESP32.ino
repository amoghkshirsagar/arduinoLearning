...
void loop() {
  ...
  int valuexa = gValue.x; // Read analog pin A0
  int valueya = gValue.y; // Read analog pin A1
  int valueza = gValue.z; // Read analog pin A2
  int valuexd = gyr.x; // Read analog pin A3
  int valueyd = gyr.y; // Read analog pin A4
  int valuezd = gyr.z; // Read analog pin A5

  // Print values with labels for Serial Plotter
  Serial.print("valuexa"); Serial.print(valuexa); Serial.print("\t");
  Serial.print("valueya"); Serial.print(valueya); Serial.print("\t");
  Serial.print("valueza"); Serial.print(valueza); Serial.print("\t");
  Serial.print("valuexd"); Serial.print(valuexd); Serial.print("\t");
  Serial.print("valueyd"); Serial.print(valueyd); Serial.print("\t");
  Serial.print("valuezd"); Serial.println(valuezd); // Last value uses println()
